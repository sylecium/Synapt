...
pub fn overlaps(a_start: &str, a_mins: i64, b_start: &str, b_mins: i64) -> Result<bool, AppError> {
...
mod tests {
    ...
    fn chevauchement_simple() {
        assert!(overlaps("2026-09-11T10:00:00Z", 60, "2026-09-11T10:30:00Z", 30).unwrap());
    }

    #[test]
    fn adjacent_pas_chevauchement() {
        assert!(!overlaps("2026-09-11T10:00:00Z", 60, "2026-09-11T11:00:00Z", 30).unwrap());
    }
}
